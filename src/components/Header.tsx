          ...
          <div
            className={
              location.pathname === "/admin/home"
                ? "flex gap-2 text-blue-500 font-latobold"
                : "flex gap-2"
            }
          >
    ...
    },
    {
      ...
      label: (
        <Link to="/admin/demande">
          <div
            className={
              location.pathname === "/admin/demande"
                ? "flex gap-2 text-blue-500 font-latobold"
                : "flex gap-2"
            }
          >
      ...
      children: [
        {
          ...
          label: (
            <Link to="/admin/demande/notorganized">
              <div
                className={
                  location.pathname === "/admin/demande/notorganized"
                    ? "flex gap-2 font-latobold items-center"
    ...
    },
    {
      ...
      label: (
        <Link to="/admin/audience">
          <div
            className={
              location.pathname === "/admin/audience"
                ? "flex gap-2 text-blue-500 font-latobold"
                : "flex gap-2"
            }
          >
      ...
      children: [
        {
          ...
          label: (
            <Link to="/admin/audience/search">
              <div
                className={
                  location.pathname === "/admin/audience/search"
                    ? "flex gap-2 text-blue-500 font-latobold"
                    : "flex gap-2"
                }
              >
    ...
    <div className="bg-five-custom shadow-sm px-4 py-3 flex justify-normal sm:justify-end">
      ...
      <div className="sm:hidden flex justify-between items-center w-full">
        <img
          src={MidLogo}
          alt="Mininter Logo"
          className="w-10 h-10 hidden object-cover"
        />

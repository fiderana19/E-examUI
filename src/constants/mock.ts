...
export const mock_annonces = [
  {
    ...
    texte_annonce:
      "Les tests sur les bases de données (UML/Merise) sont ouverts à partir d'aujourd'hui. Concerne le groupe L3 Informatique (ID 10).",
  ...
  },
  {
    ...
    texte_annonce:
      "Le tutorat de programmation aura lieu lundi à 14h en salle C-101. Concerne le groupe Tutorat Programmation (ID 14).",
  ...
  },
  {
    ...
    texte_annonce:
      "Le cours de Master 1 Cybersécurité (ID 11) est reporté à la semaine prochaine.",
  ...
  },
  {
    ...
    texte_annonce:
      "Message général de bienvenue à tous les nouveaux étudiants de L1 Tronc Commun (ID 12).",
...
export const mock_tests = [
  {
    ...
    description:
      "Évaluation sur les concepts de modélisation de données (MCD et MLD).",
    duree_minutes: 30,
    max_questions: 5,
    note_max: 20,
  ...
  },
  {
    ...
    description:
      "Évaluation des bases de la programmation, conditions et boucles.",
    duree_minutes: 90,
    max_questions: 15,
    note_max: 50,
  ...
  },
  {
    ...
    description:
      "Questions sur les protocoles sécurisés et les attaques courantes.",
    duree_minutes: 45,
    max_questions: 10,
    note_max: 40,
...
export const mock_questions = [
  ...
  },
  {
    ...
    id_test: 100,
    texte_question:
      "Définissez brièvement le rôle de l'entité-type dans le MCD.",
  ...
  },
  {
    ...
    id_test: 100,
    texte_question:
      "Expliquez la différence entre une agrégation et une composition en UML.",
    type_question: "dev",
    points: 6,
    reponse_correcte:
      "L'agrégation est une relation 'has-a' faible ; la composition est une relation 'has-a' forte où la partie ne survit pas au tout.",
    date_creation: "2025-10-11",
  },
  ...
  // Questions pour le Test 103 (Petit Test Algorithmique - En cours)
  {
    ...
    id_test: 103,
    texte_question:
      "Quelle est la valeur de Y après ces opérations : X=5; Y=X+2; X=10; ?",
    type_question: "simple",
    points: 2,
    reponse_correcte: "7",
  ...
  },
  {
    ...
    id_test: 103,
    texte_question:
      "Dans un algorithme, que représente une boucle 'tant que' ?",
    type_question: "dev",
    points: 4,
    reponse_correcte:
      "Une structure itérative permettant d'exécuter un bloc d'instructions tant qu'une condition reste vraie.",
    date_creation: "2025-10-15",
  },
  {
    id_question: 1006,
...
export const mock_optionsqcm = [
  // Options pour Q1000 (Qu'est-ce qu'une clé primaire ?) - Correcte: A
  {
    ...
    id_question: 1000,
    texte_option:
      "Un attribut ou un ensemble d'attributs qui identifie de manière unique une occurrence d'entité.",
    est_correcte: true,
  },
  {
    id_option: "B",
    id_question: 1000,
    texte_option:
      "Un attribut servant uniquement à lier deux tables dans le MLD.",
    est_correcte: false,
  },
  {
    id_option: "C",
...
export const mock_reponseetudiants_a_corriger = [
  // --- TENTATIVE 200 (Martin, Test 100) ---
  {
    ...
    id_tentative: 200,
    reponse_texte:
      "La composition est plus forte, la partie dépend du tout. L'agrégation est un lien plus lâche où les deux peuvent exister séparément.",
    score_question: 0,
  ...
  // --- TENTATIVE 202 (Garcia, Test 101) ---
  {
    ...
    id_question:
      "Décrivez les trois piliers de la Programmation Orientée Objet (POO).",
    id_tentative: 202,
  ...
  },
  {
    ...
    id_question:
      "Écrivez une fonction en pseudo-code pour calculer la factorielle d'un nombre N.",
    id_tentative: 202,
    reponse_texte:
  ...
  // --- TENTATIVE 203 (Martin, Test 102) ---
  {
    ...
    id_question:
      "Expliquez le principe du Handshake à trois voies (Three-Way Handshake) de TCP.",
    id_tentative: 203,
    reponse_texte:
      "SYN -> SYN/ACK -> ACK. Permet d'établir une connexion fiable entre deux hôtes.",
    score_question: 0,
    est_corriger: false, // À CORRIGER (10 points max)
  },
];
...
export const mockResultData = {
  ...
  resultats: [
    {
      matricule: "9999 H-F",
      nomPrenom: "LOREM Ipsum",
      note: 10,
      heureSoumission: "15:24",
    },
    {
      matricule: "9999 H-F",
      nomPrenom: "LOREM Ipsum",
      note: 11,
      heureSoumission: "15:22",
    },
    {
      matricule: "9999 H-F",
      nomPrenom: "LOREM Ipsum",
...
export const mocktestquestions = [
  ...
  // Q1 (QCM) : BDD
  {
    id_question: 1,
    texte_question:
      "Quel est l'objectif principal de la 3ème Forme Normale (3NF) ?",
    type_question: "qcm",
    points: 4,
    options: [
      {
        id_option: "A",
        texte_option: "Éliminer les dépendances fonctionnelles partielles.",
      },
      {
        id_option: "B",
        texte_option: "Éliminer les dépendances fonctionnelles transitives.",
      },
  ...
  // Q2 (SIMPLE) : Merise
  {
    id_question: 2,
    texte_question:
      "Quel sigle représente le Modèle Logique de Données dans la méthode Merise ?",
    type_question: "simple",
    points: 2,
    options: null,
  },
  ...
  // Q3 (DEV) : UML
  {
    id_question: 3,
    texte_question:
      "Expliquez brièvement la différence de sémantique entre l'agrégation et la composition dans les diagrammes de classes UML.",
    type_question: "dev",
    points: 8,
    options: null,
  },
  ...
  // Q4 (QCM) : BDD
  {
    id_question: 4,
    texte_question:
      "Dans le modèle relationnel, à quoi sert une Clé Étrangère (Foreign Key) ?",
    type_question: "qcm",
    points: 3,
    options: [
      {
        id_option: "A",
        texte_option: "À identifier uniquement chaque ligne d'une table.",
      },
      {
        id_option: "B",
        texte_option:
          "À faire respecter l'intégrité référentielle entre deux tables.",
      },
      {
        id_option: "C",
        texte_option: "À accélérer les requêtes de sélection (SELECT).",
      },
    ],
  },
  ...
  // Q5 (SIMPLE) : Merise
  {
    id_question: 5,
    texte_question:
      "Qu'est-ce qu'une cardinalité minimale de 0 dans une relation Merise ?",
    type_question: "simple",
    points: 3,
    options: null,
  },
  ...
  // Q6 (QCM) : UML
  {
    id_question: 6,
    texte_question:
      "Quel diagramme UML est principalement utilisé pour modéliser le flux de travail ou les étapes d'un processus ?",
    type_question: "qcm",
    points: 4,
    options: [
  ...
  // Q7 (DEV) : BDD/SQL
  {
    id_question: 7,
    texte_question:
      "Écrivez une requête SQL permettant de sélectionner les noms de tous les 'Utilisateurs' qui ont le rôle 'ETUDIANT'.",
    type_question: "dev",
    points: 5,
    options: null,
  },
  ...
  {
    id_question: 8,
    texte_question: "Quel est le SGBD open source le plus populaire ?",
    type_question: "simple",
    points: 2,
    options: null,
  },
  ...
  // Q9 (QCM) : Merise
  {
    id_question: 9,
    texte_question:
      "Quel niveau d'abstraction Merise est le plus proche de l'implémentation physique (fichiers, index, stockage) ?",
    type_question: "qcm",
    points: 3,
    options: [
  ...
  // Q10 (DEV) : UML
  {
    id_question: 10,
    texte_question:
      "Modélisez l'héritage d'une 'Personne' vers une 'Client' et un 'Fournisseur' en notation de Diagramme de Classes UML (décrivez seulement les classes et la relation).",
    type_question: "dev",
    points: 7,
    options: null,
  },
  ...
  // Q11 (QCM) : Algorithmique
  {
    id_question: 11,
    texte_question:
      "Quelle structure algorithmique permet de répéter un bloc d'instructions un nombre défini de fois ?",
    type_question: "qcm",
    points: 3,
    options: [
  ...
  // Q12 (DEV) : Algorithmique
  {
    id_question: 12,
    texte_question:
      "Écrivez le pseudo-code de l'algorithme qui calcule le factoriel d'un nombre entier N.",
    type_question: "dev",
    points: 10,
    options: null,
  },
  ...
  // Q13 (SIMPLE) : Logique
  {
    id_question: 13,
    texte_question:
      "Quelle est la valeur de la variable 'res' après l'exécution : $res = 10$; $res = res / 2 + 1$; $res = res * 3$;",
    type_question: "simple",
    points: 4,
    options: null,
  },
  ...
  // Q14 (QCM) : Algorithmique
  {
    id_question: 14,
    texte_question:
      "Quelle est la complexité algorithmique d'une recherche dichotomique sur un tableau trié de taille N ?",
    type_question: "qcm",
    points: 4,
    options: [
  ...
  // Q15 (SIMPLE) : Logique
  {
    id_question: 15,
    texte_question:
      "Dans une condition, si 'A' est VRAI et 'B' est FAUX, que vaut 'NON (A OU B)' ?",
    type_question: "simple",
    points: 3,
    options: null,
  },
  ...
  // Q16 (DEV) : Algorithmique
  {
    id_question: 16,
    texte_question:
      "Décrivez les étapes de tri par sélection (Selection Sort).",
    type_question: "dev",
    points: 6,
    options: null,
  },
  ...
  // Q17 (QCM) : BDD/SQL
  {
    id_question: 17,
    texte_question:
      "Quel mot-clé SQL est utilisé pour combiner les résultats de deux requêtes SELECT ?",
    type_question: "qcm",
    points: 3,
    options: [
  ...
  // Q18 (SIMPLE) : Merise
  {
    id_question: 18,
    texte_question:
      "À quel niveau d'abstraction (Merise) correspond le Modèle Entité-Relation (MER) ?",
    type_question: "simple",
    points: 2,
    options: null,
  },
  ...
  // Q19 (DEV) : Synthèse
  {
    id_question: 19,
    texte_question:
      "Pourquoi est-il crucial de modéliser les données avant de commencer à coder l'application (justifiez en termes de coûts et d'erreurs) ?",
    type_question: "dev",
    points: 5,
    options: null,
  },
  ...
  {
    id_question: 20,
    texte_question: "Une variable locale dans une fonction existe :",
    type_question: "qcm",
    points: 3,
    options: [
      {
        id_option: "A",
        texte_option: "Pendant toute l'exécution du programme.",
      },
      {
        id_option: "B",
        texte_option: "Uniquement pendant l'exécution de cette fonction.",
      },
      {
        id_option: "C",
        texte_option:
          "Uniquement dans le bloc conditionnel où elle est déclarée.",
      },
    ],
  },
];

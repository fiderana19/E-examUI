        ...
        <div className="w-1/4 mx-auto">
            ...
            <Card className="px-4 py-10">
                            ...
                            <div className='relative'>
                                <Controller 
                                    ...
                                    render={({
                                        ...
                                        <Input value={value} onChange={onChange} onBlur={onBlur} type={!!(isPasswordVisible) ? 'text' : 'password'} className={`${errors?.motdepasse && 'border border-red-500 text-red-500 rounded'}`} />
                                    )}
                                />
                                {
                                    isPasswordVisible ?
                ...
                <Link to="/signup" className="w-max mx-auto">
                    <Button variant={'link'} className="w-max">S'incrire</Button>
                </Link>
            </Card>
        </div>
    </div>

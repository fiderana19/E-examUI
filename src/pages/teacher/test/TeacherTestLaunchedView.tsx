...
const TeacherTestLaunchedView: React.FC  = () => {
    ...
    return <div className="pl-64 pt-4 pr-6">
        <TeacherNavigation />
        {
            test &&
            <div className="">
                <div className="">
                    ...
                    <div className="flex justify-between my-1">
                        <div className="flex gap-4">
                            <div className="font-bold text-lg text-gray-600">15 questions max</div>
                        </div>
                ...
                <Card className="my-10 w-max mx-auto px-4">
                    <div>
                        ...
                        <div className="mx-auto w-max mt-2"><ClokcTest afterTimeOver={finishTest} /></div>
                    </div>
                </Card>
            </div>
        }

    ...
    return <div className="pl-64 pr-6">
        ...
        <div className="my-6">
            <div className="flex justify-between items-center">
                <div className="text-xl uppercase font-bold">Les resultats publiés</div>
                <Popover>
                  <PopoverTrigger asChild>
                    <Button><Plus /> Nouvelle publication</Button>
                  </PopoverTrigger>
                  <PopoverContent className="w-auto p-6 mr-6">
                      <div className="mb-2 text-gray-700 font-medium">Publier un resultat</div>
                      <form onSubmit={submit(handleSubmit)} className="w-64 mx-auto">
                          ...
                          <Controller
                              ...
                              name="titre_resultat"
                              render={({ field: { value, onChange } }) => (
                                  <Input value={value} onChange={onChange} className={`${errors?.titre_resultat && 'border border-red-500 text-red-500 rounded'}`} />
                              )}
                          />

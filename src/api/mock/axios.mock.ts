...
let users = [
  {
    ...
    role: "student",
    est_valider: true,
    creation_utilisateur: getCurrentDate(10),
  },
  {
    id_utilisateur: 2,
    id_groupe: 101,
    ...
    role: "teacher",
    est_valider: true,
    creation_utilisateur: getCurrentDate(15),
  },
  {
    id_utilisateur: 3,
    nom: "Charlie Legrand",
    email: "charlie.l@univ.fr",
    matricule: "S002",
    role: "student",
    est_valider: false,
    creation_utilisateur: getCurrentDate(8),
  },
  {
    id_utilisateur: 4,
    nom: "Diane Petit",
    email: "diane.p@univ.fr",
    matricule: "T002",
    role: "teacher",
    est_valider: true,
    creation_utilisateur: getCurrentDate(20),
  },
  {
    id_utilisateur: 5,
    nom: "Eve Dubois",
    ...
    role: "admin",
    est_valider: true,
    creation_utilisateur: getCurrentDate(5),
  },
];
...
let groupes = [
  {
    id_groupe: 101,
    nom_groupe: "L3 Informatique 2024",
    description: "Cours de programmation avancée.",
    id_utilisateur: 2,
  }, // Bob est le créateur
  {
    id_groupe: 102,
    nom_groupe: "Master 1 CyberSec",
    description: "Sécurité et Réseaux.",
    id_utilisateur: 4,
  }, // Diane est la créatrice
  {
    id_groupe: 103,
    nom_groupe: "Projet Final",
    description: "Groupe pour le projet de fin d'année.",
    id_utilisateur: 2,
  },
];
...
let tests = [
  ...
  {
    id_test: 1001,
    titre: "Examen Final JS Avancé",
    status: "En cours",
    id_groupe: 101,
    max_questions: 30,
    note_max: 50,
    date_declenchement: getCurrentDate(1),
  },
  // Test 2: Terminé (pour les statistiques)
  {
    id_test: 1002,
    titre: "Quiz HTML/CSS Basique",
    status: "Terminé",
    id_groupe: 101,
    max_questions: 15,
    note_max: 20,
    date_declenchement: getCurrentDate(7),
  },
  // Test 3: En Attente (valeurs par défaut)
  {
    id_test: 1003,
    titre: "Contrôle Continû M1",
    status: "En attente",
    id_groupe: 102,
    max_questions: 15,
    note_max: 20,
  ...
  // Test 4: Terminé (plus de tentatives non notées)
  {
    ...
    max_questions: 20,
    note_max: 40,
    date_declenchement: getCurrentDate(3),
  },
];
...
let questions = [
  ...
  // QCM (points=1)
  {
    ...
    id_test: 1001,
    texte_question:
      "Quelle méthode crée un nouveau tableau avec les résultats de l'appel d'une fonction fournie sur chaque élément du tableau appelant ?",
    type_question: "qcm",
    points: 1,
    reponse_correcte: "map",
  },
  {
    id_question: 2,
    id_test: 1001,
    texte_question: "Comment déclarer une constante en JavaScript ?",
    type_question: "qcm",
    points: 1,
    reponse_correcte: "const",
  },
  {
    id_question: 3,
    id_test: 1001,
    texte_question: 'Le "Hoisting" fonctionne-t-il avec `let` et `const` ?',
    type_question: "qcm",
    points: 1,
  ...
  },
  {
    ...
    id_test: 1001,
    texte_question:
      "Quel est l'équivalent de `==` mais qui compare aussi les types ?",
    type_question: "qcm",
    points: 1,
    reponse_correcte: "===",
  },
  {
    id_question: 5,
    id_test: 1001,
    texte_question: "Comment ajouter un élément à la fin d'un tableau ?",
    type_question: "qcm",
    points: 1,
    reponse_correcte: "push",
  },
  {
    id_question: 6,
    id_test: 1001,
    texte_question: "Quel est l'opérateur de propagation (Spread Operator) ?",
    type_question: "qcm",
    points: 1,
    reponse_correcte: "...",
  },
  {
    ...
    id_test: 1001,
    texte_question:
      "Quelle boucle est utilisée pour itérer sur les propriétés d'un objet ?",
    type_question: "qcm",
    points: 1,
    reponse_correcte: "for...in",
  },
  {
    id_question: 8,
    id_test: 1001,
    texte_question:
      "Le mot clé `this` est-il toujours statique dans une fonction fléchée ?",
    type_question: "qcm",
    points: 1,
  ...
  },
  {
    id_question: 9,
    id_test: 1001,
    texte_question: "Quelle est la valeur de `typeof null` ?",
    type_question: "qcm",
    points: 1,
    reponse_correcte: "object",
  },
  {
    id_question: 10,
    id_test: 1001,
    texte_question:
      "Que retourne la méthode `filter` si aucun élément ne correspond ?",
    type_question: "qcm",
    points: 1,
    reponse_correcte: "tableau_vide",
  },
  ...
  // Réponse Courte (points=1)
  {
    id_question: 11,
    id_test: 1001,
    texte_question: "Quel est l'acronyme pour XML?",
    type_question: "reponse_courte",
    points: 1,
    reponse_correcte: "eXtensible Markup Language",
  },
  {
    id_question: 12,
    id_test: 1001,
    texte_question: "Quel port utilise le HTTPS?",
    type_question: "reponse_courte",
    points: 1,
    reponse_correcte: "443",
  },
  {
    id_question: 13,
    id_test: 1001,
    texte_question: "Nommez une structure de données FIFO.",
    type_question: "reponse_courte",
    points: 1,
    reponse_correcte: "Queue",
  },
  {
    id_question: 14,
    id_test: 1001,
    texte_question: "Que signifie SQL?",
    type_question: "reponse_courte",
    points: 1,
    reponse_correcte: "Structured Query Language",
  },
  {
    id_question: 15,
    id_test: 1001,
    texte_question: "Nommez le protocole de messagerie simple.",
    type_question: "reponse_courte",
    points: 1,
  ...
  // Développement (points=2)
  {
    id_question: 16,
    id_test: 1001,
    texte_question: "Décrivez les différences entre `var`, `let` et `const`.",
    type_question: "developpement",
    points: 2,
  ...
  },
  {
    id_question: 17,
    id_test: 1001,
    texte_question: "Expliquez ce qu'est une Promise en JavaScript.",
    type_question: "developpement",
    points: 2,
    reponse_correcte: null,
  },
  {
    id_question: 18,
    id_test: 1001,
    texte_question: "Comment fonctionne l'héritage prototypal?",
    type_question: "developpement",
    points: 2,
    reponse_correcte: null,
  },
  {
    ...
    id_test: 1001,
    texte_question:
      "Donnez un cas d'utilisation de l'opérateur Nullish Coalescing (??).",
    type_question: "developpement",
    points: 2,
    reponse_correcte: null,
  },
  {
    id_question: 20,
    id_test: 1001,
    texte_question: "Décrivez le cycle de vie d'un composant React (Hooks).",
    type_question: "developpement",
    points: 2,
    reponse_correcte: null,
  },
  ...
  // TEST 1002 (HTML/CSS Basique) - pour les réponses des tentatives
  {
    id_question: 21,
    id_test: 1002,
    texte_question: "Quelle balise utilise-t-on pour lier un fichier CSS ?",
    type_question: "reponse_courte",
    points: 1,
    reponse_correcte: "link",
  },
  {
    id_question: 22,
    id_test: 1002,
    texte_question: "Propriété CSS pour centrer un bloc.",
    type_question: "reponse_courte",
    points: 1,
    reponse_correcte: "margin: auto",
  },
];
...
let annonces = [
  // Annonces pour le Groupe 101
  {
    ...
    id_utilisateur: 2,
    id_groupe: 101,
    titre_annonce: "Rappel Examen",
    texte_annonce:
      "L'examen final aura lieu la semaine prochaine, révisez bien les Promises et Hoisting.",
    creation_annonce: getCurrentDate(2),
  },
  {
    id_annonce: 2,
    id_utilisateur: 2,
    id_groupe: 101,
    titre_annonce: "Séance Questions-Réponses",
    texte_annonce:
      "Je serai disponible en ligne demain à 14h pour vos questions.",
    creation_annonce: getCurrentDate(1),
  },
  {
    id_annonce: 3,
    id_utilisateur: 4,
    id_groupe: 101,
    titre_annonce: "Changement de Salle",
    texte_annonce: "La salle de TP a été déplacée en B304.",
    creation_annonce: getCurrentDate(0),
  }, // La plus récente
  ...
  // Annonces pour le Groupe 102
  {
    ...
    id_utilisateur: 4,
    id_groupe: 102,
    titre_annonce: "Bienvenue",
    texte_annonce: "Début du module cryptographie. Lisez le chapitre 1.",
    creation_annonce: getCurrentDate(5),
  },
];
...
let tentatives = [
  // Tentative 1 (Alice sur Test 1002 - Terminé, Noté)
  {
    ...
    id_utilisateur: 1,
    id_test: 1002,
    heure_debut: getCurrentDate(6),
    heure_soumission: getCurrentDate(6),
    note_obtenue: 15,
    est_noter: true,
  },
  ...
  // Tentative 3 (Eve sur Test 1001 - En cours, Non soumise)
  {
    ...
    id_utilisateur: 5,
    id_test: 1001,
    heure_debut: getCurrentDate(0),
    heure_soumission: null,
    note_obtenue: 0,
    est_noter: false,
  },
  // Tentative 4 (Alice sur Test 1004 - Soumise, Non Notée)
  {
    ...
    id_utilisateur: 1,
    id_test: 1004,
    heure_debut: getCurrentDate(2),
    heure_soumission: getCurrentDate(2),
    note_obtenue: 0,
    est_noter: false,
  },
];
...
const reponses = [
  ...
  // R22: Incorrect (simulant un score manquant pour un total de 15/20)
  {
    ...
    id_tentative: 1,
    id_question: 22,
    reponse_texte: "text-align: center",
    score_question: 0,
    est_corriger: true,
  },
  ...
  // R: Dev, non corrigée
  {
    ...
    id_tentative: 4,
    id_question: 16,
    reponse_texte: "var est globale, let/const sont locales...",
    score_question: 0,
    est_corriger: false,
  },
  // R: Courte, auto-corrigée
  {
    ...
    id_tentative: 4,
    id_question: 14,
    reponse_texte: "Structured Query Language",
    score_question: 1,
    est_corriger: true,
  },
];
...
let resultats = [
  {
    ...
    id_test: 1002,
    note_finale: 15,
    date_publication: getCurrentDate(5),
  },
  {
    id_resultat: 2,
    id_utilisateur: 3,
...
const calculateDefaultScoreAndCorrection = (question: any) => {
  ...
  if (
    ...
    question.type_question === "reponse_courte"
  ) {
    est_corriger = true;
...
mock.onPost("/question").reply((config) => {
  ...
  switch (newQuestion.type_question) {
    ...
    case "reponse_courte":
      points = 1;
      reponse_correcte =
        newQuestion.type_question === "qcm"
          ? null
          : newQuestion.reponse_correcte || null;
      break;
    case "developpement":
      points = 2;
      reponse_correcte = null;
...
mock.onGet(/\/question\/test\/\d+\/aleatoire/).reply((config: any) => {
  ...
  // Filtres
  const qcm = availableQuestions
    .filter((q) => q.type_question === "qcm")
    .sort(() => 0.5 - Math.random());
  const courte = availableQuestions
    .filter((q) => q.type_question === "reponse_courte")
    .sort(() => 0.5 - Math.random());
  const dev = availableQuestions
    .filter((q) => q.type_question === "developpement")
    .sort(() => 0.5 - Math.random());
...
mock.onPut(/\/tentative\/\d+\/terminer/).reply((config: any) => {
  ...
  if (tentative) {
    ...
    tentative.note_obtenue = tentativeReponses.reduce(
      (sum, r) => sum + r.score_question,
      0,
    );
...
mock.onPost("/reponse").reply((config) => {
  ...
  const { est_corriger, score_question } =
    calculateDefaultScoreAndCorrection(question);
  ...
  if (
    newReponseData.est_corriger &&
    newReponse.reponse_texte &&
...
mock.onPut(/\/reponse\/\d+\/score/).reply((config: any) => {
  ...
  if (reponse) {
    ...
    const tentative = tentatives.find(
      (t) => t.id_tentative === reponse.id_tentative,
    );
    if (tentative) {
      const tentativeReponses = reponses.filter(
        (r) => r.id_tentative === tentative.id_tentative,
      );
      tentative.note_obtenue = tentativeReponses.reduce(
        (sum, r) => sum + r.score_question,
        0,
...
const findTentative = (id: any) =>
  tentatives.find((t) => t.id_tentative === id);
...
mock.onGet("/utilisateur").reply(
  200,
  users
    .filter((u) => u.role === "student" || u.role === "teacher")
    .sort(
      (a, b) =>
        new Date(b.creation_utilisateur).getTime() -
        new Date(a.creation_utilisateur).getTime(),
    ),
);
...
mock.onGet(/\/annonce\/groupe\/\d+\/dernieres/).reply((config: any) => {
  ...
  const groupAnnonces = annonces
    ...
    .sort(
      (a, b) =>
        new Date(b.creation_annonce).getTime() -
        new Date(a.creation_annonce).getTime(),
    )
    .slice(0, 3);
...
mock.onGet(/\/resultat\/groupe\/\d+/).reply((config: any) => {
  const id_groupe = parseInt(config.url.split("/").pop());
  const testsDuGroupe = tests
    .filter((t) => t.id_groupe === id_groupe)
    .map((t) => t.id_test);
  const filteredResults = resultats.filter((r) =>
    testsDuGroupe.includes(r.id_test),
  );
...
mock.onGet(/\/reponse\/test\/\d+\/tentative\/\d+/).reply((config: any) => {
  ...
  return [
    200,
    tentativeReponses.filter(
      (r) => findQuestion(r.id_question)?.id_test === id_test,
    ),
  ];
});
...
mock.onGet("/reponse/non-corriger").reply(
  200,
...
mock.onGet(/\/test\/groupe\/\d+\/encours/).reply((config: any) => {
  ...
  const filteredTests = tests.filter(
    (t) => t.id_groupe === id_groupe && t.status === "En cours",
  );
...
mock.onGet(/\/test\/utilisateur\/\d+/).reply((config: any) => {
  ...
  const userGroups = groupes
    .filter((g) => g.id_utilisateur === id_utilisateur)
    .map((g) => g.id_groupe);
...
mock.onGet("/test/a-noter").reply(
  200,
  tests.filter((t) =>
    tentatives.some((tt) => tt.id_test === t.id_test && tt.est_noter === false),
  ),
);

// Logique pour les statistiques des tests notés
const calculateTestStats = (testId: any) => {
  const testTentatives = tentatives.filter(
    (t) => t.id_test === testId && t.est_noter === true,
  );
  ...
  const reussite = testTentatives.filter(
    (t) => t.note_obtenue >= moyenne,
  ).length;
...
mock.onGet("/test/statistiques").reply(
  200,
  tests
    .filter(
      (t) =>
        t.status === "Terminé" &&
        tentatives.every(
          (tt) => tt.id_test !== t.id_test || tt.est_noter === true,
        ),
    )
